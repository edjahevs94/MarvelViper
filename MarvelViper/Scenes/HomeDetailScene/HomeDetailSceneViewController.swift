...
class HomeDetailSceneViewController: UIViewController {
    ...
    func setupView() {
        ...
        resourceDescription.topAnchor.constraint(equalTo: resourceImage.bottomAnchor, constant: 10).isActive = true
        resourceDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 5).isActive = true
        resourceDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -5).isActive = true
