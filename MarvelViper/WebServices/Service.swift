...
class MarvelService {
    ...
    func getComicCharacters(comicId: Int, completion: @escaping(Welcome) ->()) {
        let fullUrl = "https://gateway.marvel.com:443/v1/public/characters/\(comicId)/comics?ts=1&apikey=0b2ab777bfbcd8a87de197eb7ae78888&hash=1d0846bfe34189618275355b4ce87cb2"
        
        AF.request(fullUrl, method: .get).responseDecodable(of: Welcome.self) { response in
            switch response.result {
            case .success(let data):
